...
const myTeamSection = document.querySelector<HTMLDivElement>("#my-team-section");
const enemyTeamSection = document.querySelector<HTMLDivElement>("#enemy-team-section");
...
enemyTeamSection.innerHTML = createTeamSection("enemyTeam", "Вражеская команда");
